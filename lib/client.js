...
SMTPClient.prototype._actionGreeting = function(str){
    ...
    self = this;
    this._currentEhloIntervalCount = 0;
    this._currentEhloInterval = setInterval(function(){
        if(self._currentEhloIntervalCount > 8 || self._destroyed || self._currentAction != self._actionEHLO){
            console.log("Stopping sending EHLO's because of some condition");
            clearInterval(this);
            return;
        }
        console.log("Sending a duplicate EHLO and " + self._currentEhloIntervalCount);
        self._currentEhloIntervalCount++;
...
SMTPClient.prototype._actionEHLO = function(str){
    clearInterval(this._currentEhloInterval);
